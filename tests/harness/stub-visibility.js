// Stub Supabase untuk tests/owner-visibility.harness.mjs. Direkatkan lewat alias
// di tests/harness/vite.visibility.config.js.
//
// KENAPA STUB-NYA ADA DUA: yang ini TABLE-AWARE (wallets / wallet_members /
// transactions punya data sendiri) dan menangkap argumen .or()/.eq('user_id') —
// persis yang di-assert regresi owner-visibility. Tetangganya, supabase-stub.js,
// justru fokus ke siklus tulis (rpc hold/release untuk drainWrites) dan tidak
// membedakan tabel, jadi keduanya tidak bisa saling menggantikan. Alias vite
// berlaku se-server, jadi tiap stub wajib punya config + halaman entry sendiri.
// TODO: pertimbangkan digabung jadi SATU stub tabel-aware setelah Fase 2
// realtime selesai, supaya tidak ada dua infrastruktur harness yang dirawat.
//
// Catatan asal-usul: stub regresi hotfix owner-cant-see-member-transactions.
