...
const STEPS = [
  { targetIds: ['budget-period-toggle'], titleKey: 'tour.anggaran.gantiTampilan.title', descKey: 'tour.anggaran.gantiTampilan.desc' },
  { targetIds: ['budget-add-category'],  titleKey: 'tour.anggaran.tambahKategori.title', descKey: 'tour.anggaran.tambahKategori.desc' },
];
...
export default function BudgetsTour({ isActive, onComplete }) {
  ...
  // elemen belum ter-mount saat step berganti. Sengaja TIDAK pakai useScrollLock:
  // tour ini justru butuh background bisa discroll (baik oleh scrollIntoView
  // otomatis maupun user manual) supaya target di bawah fold kelihatan.
  // Spotlight/tooltip tetap sinkron karena di-update live lewat listener
  // scroll/resize di bawah.
  React.useEffect(() => {
