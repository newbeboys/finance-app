...
const STEPS = [
  { targetIds: ['debts-add'],  titleKey: 'tour.hutangPiutang.catatBaru.title',   descKey: 'tour.hutangPiutang.catatBaru.desc' },
  { targetIds: ['debts-tabs'], titleKey: 'tour.hutangPiutang.gantiTampilan.title', descKey: 'tour.hutangPiutang.gantiTampilan.desc' },
];
...
export default function HutangPiutangTour({ isActive, onComplete }) {
