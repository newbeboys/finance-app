...
const TOUR_Z = 900; // sengaja pakai nilai sama seperti tour lain — halaman ini
// (RecurringTransactionPage) sendiri position:fixed + z-index:1200, yang
// membentuk stacking context baru. Karena tour ini dirender SEBAGAI CHILD di
// dalam container itu, TOUR_Z=900 cukup: dibandingkan hanya terhadap sibling
// lain di dalam context yang sama (header/list, tanpa z-index eksplisit),
// bukan terhadap elemen di luar halaman ini.
const CUTOUT_PAD = 8;
...
const STEPS = [
  { targetIds: ['recurring-add'], titleKey: 'tour.berulang.tambahJadwal.title', descKey: 'tour.berulang.tambahJadwal.desc' },
];
...
export default function RecurringTour({ isActive, onComplete }) {
