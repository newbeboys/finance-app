...
| 9 Sep | Migration `20260909000000_add_wallet_id_to_budgets.sql` dibuat — kolom `budgets.wallet_id` (FK wallets, ON DELETE SET NULL, NULL = semua dompet) | ❌ Belum di-push | Claude Code |
